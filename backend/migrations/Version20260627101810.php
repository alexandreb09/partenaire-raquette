 ...
 */
final class Version20260627101810 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `user` MODIFY preferred_surface LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:json)\'');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `user` MODIFY preferred_surface VARCHAR(10) DEFAULT NULL');
